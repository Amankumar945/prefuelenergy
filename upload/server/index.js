...
// CORS configuration - allow requests from the main domain
app.use(cors({
  origin: ['https://sorsuvidhacloudsystems.com', 'http://localhost:5173'],
  credentials: true,
...
// Manual CORS headers as backup (in case cors middleware fails)
app.use((req, res, next) => {
  res.header('Access-Control-Allow-Origin', 'https://sorsuvidhacloudsystems.com');
